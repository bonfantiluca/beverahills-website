...
const ContattiPage =  () => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 space-y-8 lg:grid-cols-2 lg:space-x-8 lg:space-y-0 my-auto lg:h-52" >
            <motion.div 
            ...
            >
                ...
                <p className="text-lg ">Email: <a href="mailto:info@beverahills.it" className="text-rosso font-semibold underline">info@beverahills.it</a></p>
